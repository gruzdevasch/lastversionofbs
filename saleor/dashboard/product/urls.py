...
urlpatterns = [
    ...
    url(r'^import-product-csv/$',
        views.simple_product_upload, name='simple_product_upload'),
    url(r'^import-picture-csv/$',
        views.simple_picture_upload, name='simple_picture_upload'),
    url(r'^import-variant-csv/$',
        views.simple_variant_upload, name='simple_variant_upload'),
    url(r'^bulk-update/$',
